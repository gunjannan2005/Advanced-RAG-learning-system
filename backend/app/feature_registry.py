...
feature_registry.py
====================
Central Feature Registry — Advanced-RAG-learning-system Enterprise AI Learning Platform
...
PLATFORM_METADATA = {
    "name": "Advanced-RAG-learning-system — Enterprise AI Learning Platform",
    "version": "2.0.0",
