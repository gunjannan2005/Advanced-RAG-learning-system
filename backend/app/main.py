"""FastAPI main application — Advanced-RAG-learning-system entry point.
...
async def lifespan(app: FastAPI):
    ...
    logger.info("=" * 60)
    logger.info("Starting Advanced-RAG-learning-system...")
...
app = FastAPI(
    title="Advanced-RAG-learning-system",
...
if FRONTEND_DIR.exists():
    ...
    @app.get("/")
    async def root():
        return {"message": "Advanced-RAG-learning-system", "docs": "/docs"}
