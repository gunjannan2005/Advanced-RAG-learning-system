# 🔗 DEPENDENCY_GRAPH.md — Advanced-RAG-learning-system Module Dependency Map
 
This document outlines the dependencies, interfaces, critical paths, latency hotspots, and broken coupling across the Advanced-RAG-learning-system codebase.
